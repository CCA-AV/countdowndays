...
function script_properties()
	...
	obs.obs_properties_add_text(props, "stop_text", "Final Text -or-", obs.OBS_TEXT_DEFAULT)
	...
	obs.obs_properties_add_bool(props, "stop_recording", "Auto-Stop Recording")
	obs.obs_properties_add_bool(props, "stop_streaming", "Auto-Stop Streaming")
...
function script_description()
	return "Timer Source counts down to 00:00 and displays Final Text  [by Jim]\n-or- forwards to Next Scene.  [by Brent@EmbodyWisdom.Today]"
end
...
function script_defaults(settings)
	...
	obs.obs_data_set_default_int(settings, "seconds", 0)	obs.obs_data_set_default_bool(settings, "stop_streaming", false)	obs.obs_data_set_default_bool(settings, "stop_recording", false)
